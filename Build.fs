...
Target.create "Azure" (fun _ ->
    ...
    deployment
    |> Deploy.execute "thisisnotarecipe.blog" Deploy.NoParameters
    |> ignore)
...
Target.create "RunTests" (fun _ ->
    ...
    [ "server", dotnet "watch run" serverTestsPath
      "client",
      dotnet "fable watch -o output -s --run webpack-dev-server --config ../../webpack.tests.config.js" clientTestsPath ]
    |> runParallel)
